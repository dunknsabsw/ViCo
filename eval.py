...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--llama_model_path', default='/root/cj/pretrained/llama/', type=str, help='path of llama model')
    ...
    parser.add_argument('--max_caption_len', type=int, default=256, metavar='LENGTH',
