...
#     debugpy.listen(("localhost", 13542))
...
def get_args_parser():
    ...
    parser.add_argument('--max_cap_len', type=int, default=256, metavar='LENGTH', help='the maximum sequence length')
    ...
    parser.add_argument('--output_dir', default='/root/cj/Flipped-VQA-master/output_dir', help='path where to save, empty for no saving')
    ...
    parser.add_argument('--init_eval', action='store_true', help='eval at epoch -1')
...
def main(args):
    ...
    if args.init_eval:
        ...
        log_stats = {'epoch': epoch, **{f'val_{k}': v for k, v in val_stats.items()}}
